          ...
          (project-list
           (condition-case err
             ...
             (error
              ...
              nil))))
      (mapcar (lambda (path) (expand-file-name path root-dir)) project-list)))
...
Someday/Maybe entries.  These are signalled using tags.
...
#+BEGIN_SRC emacs-lisp
  (me/define-agenda "n" "Next Actions"
                    `((agenda "" ((org-agenda-span 1) (org-deadline-warning-days 7)))
                      ...
                      (org-ql-block '(and (todo ,org/task-next) (priority <= "C"))
