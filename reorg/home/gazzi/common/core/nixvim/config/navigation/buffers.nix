...

{
  programs.nixvim = {
    ...
    keymaps = lib.custom.nixvim.keymapGroup "<leader>b" [
      {
        key = "c";
      ...
      }
      {
        key = "d";
        action = ":Bwipeout<CR>";
        options.desc = "Wipeout current buffer keeping window layout";
      }
      {
        key = "l";
        action = ":b#<CR>";
        options.desc = "Switch to last used buffer";
      }
      {
        key = "o";
        action = ":%bd \\| :e #<CR>";
      ...
      }
      {
        key = "D";
        action = ":bwipeout<CR>";
        options.desc = "Wipeout current buffer";
      }
    ];
  };
}
