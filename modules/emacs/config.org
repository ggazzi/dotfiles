...
I often use =smerge-mode= when I run into conflicts.
I want good keyboard shortcuts for it.
...
(map! :map smerge-mode-map
      ...
      :n "n" #'smerge-next
      :n "p" #'smerge-prev
      :n "C" #'smerge-combine-with-next
      :n "R" #'smerge-refine

      :prefix ("g m k" . "smerge-keep")
      :n "a" #'smerge-keep-all
      :n "b" #'smerge-keep-base
      :n "u" #'smerge-keep-upper
      :n "l" #'smerge-keep-lower
      :n "o" #'smerge-keep-other)
#+end_src
...
I often use `jest` as a testing framework, so I want better access to their tests.
...
(use-package! jest
  :after js2-mode
  :hook ((js2-mode rxjs-mode typescript-mode) . jest-minor-mode)
  :init
  (map! :map jest-minor-mode-map
        :localleader
        :n "j" #'jest-popup))
#+end_src
