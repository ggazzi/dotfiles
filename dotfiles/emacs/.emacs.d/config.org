...
#+BEGIN_SRC emacs-lisp
  ...
  (defvar me/gtd-inbox-file (concat me/gtd-directory "/inbox.org")
    "Org file where new tasks and ideas are collected")

  (defvar me/gtd-projects-file (concat me/gtd-directory "/projects.org")
    "Org file where projects are listed and planned")

  (defvar me/gtd-someday-file (concat me/gtd-directory "/someday.org")
    "Org file for suspended ideas and tasks")

  (defvar me/gtd-tickler-file (concat me/gtd-directory "/tickler.org")
...
then check the =NEXT= tasks, filtered by your current context.
...
defined to, e.g., show only the next tasks, filter them by context.
