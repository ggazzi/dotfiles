...

{
  programs.nixvim = {
    ...
    plugins.which-key.settings.spec = [
      ...
      {
        __unkeyed-1 = "gi";
        desc = "Last insertion (and insert mode)";
      }
      {
        __unkeyed-1 = "gg";
        desc = "First line";
      ...
      {
        __unkeyed-1 = "gv";
        desc = "Last selection (and visual mode)";
      }
      {
        __unkeyed-1 = "gf";
        desc = "File under cursor";
      }
      {
        __unkeyed-1 = "gn";
    ...
    keymaps = lib.custom.nixvim.keymapGroup "g" [
      {
        key = "h";
        action = "^";
