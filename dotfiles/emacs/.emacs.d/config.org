...
We also use auto-completion of bibtex keys.  The completion function has to be
modified to allow for fuzzy matching, and to show more readable annotations.
