...
#+BEGIN_SRC emacs-lisp
  ...
  `org-src--construct-edit-buffer-name'."
    ...
    (mapc (lambda (fn) (funcall fn)) me/org-config-hook) ; Run all registered config functions
...
for list items.
 ...
 #+BEGIN_SRC emacs-lisp
   (use-package org-bullets
     ...
     :hook
     (org-bullets-mode
      . (lambda () (font-lock-add-keywords 'org-mode
                                           '(("^[[:space:]]*\\([-]\\) "
  ...
  (defun me/config-org-fixed-width ()
    (mapc (lambda (face)
          ...
          '(org-code org-block org-block-begin-line org-block-end-line
                     org-verbatim org-table org-indent
...
#+BEGIN_SRC emacs-lisp
  (defvar me/gtd-work-projects-file (expand-file-name "~/tubCloud/GTD/projects.org"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (config-org-mode
   ...
   (setq org-stuck-projects '("+PROJ" ("NEXT" "TODO"))))
#+END_SRC
